...
SPRITE_SCALING = 0.5
PLAYER_SPRITE_SCALING = 1.5

SPRITES_FOLDER_PATH = "assets/sprites/"
PLAYER_PATH = SPRITES_FOLDER_PATH + "exampleSprite1.png"
COIN_PATH = SPRITES_FOLDER_PATH + "coinSprite1.png"
WALL_PATH = ":resources:images/tiles/grassMid.png"
...
class MyGame(arcade.Window):
    ...
    def setup(self):
        ...
        # Set up the player
        self.player_sprite = arcade.Sprite(PLAYER_PATH, PLAYER_SPRITE_SCALING)
        ...
        # Create floor
        for i in range(30):
            wall = arcade.Sprite(WALL_PATH, SPRITE_SCALING)
            wall.bottom = 0
